...
function SubmitButton({ loading }: SubmitButtonProps) {
  ...
  return (
    <Button
      type="submit"
      className="flex h-10 items-center justify-center rounded-lg bg-blue-600 dark:bg-blue-800 dark:hover:bg-blue-900 w-[152px] text-sm font-medium text-white transition-colors hover:bg-blue-400 shadow-md"
