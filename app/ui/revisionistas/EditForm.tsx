...
export default function EditRevisionistaForm({
  revisionista,
  onSubmit,
  loading
}: {
            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  id="feminino"
                  {...register("sexo")}
                  defaultChecked={revisionista.sexo === "Feminino"}
                  type="radio"
                  value="Feminino"
              ...
              <div className="flex items-center">
                <input
                  id="masculino"
                  {...register("sexo")}
                  defaultChecked={revisionista.sexo === "Masculino"}
                  type="radio"
                  value="Masculino"
                  className="h-4 w-4 cursor-pointer border-gray-300 bg-gray-100 text-gray-600 focus:ring-2"
                  aria-describedby="sexo-error"
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                id="telefone"
                {...register("telefone")}
                defaultValue={revisionista.telefone}
                type="tel"
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              <option
                value="Selecione uma forma de pagamento"
                disabled>
                Selecione uma forma de pagamento
              </option>
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={revisionista.telefone_contato1}
                type="tel"
                placeholder="48999999999"
                maxLength={11}
                className="peer block w-full rounded-md border border-gray-200 dark:border-none
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={revisionista.telefone_contato2}
                type="tel"
                placeholder="48999999999"
                maxLength={11}
                className="peer block w-full rounded-md border border-gray-200 dark:border-none
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                defaultValue={revisionista.telefone_contato3}
                type="tel"
                placeholder="48999999999"
                maxLength={11}
                className="peer block w-full rounded-md border border-gray-200 dark:border-none
